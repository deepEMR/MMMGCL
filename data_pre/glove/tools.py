...
class ClinicalDataPreprocess(object):
    def __init__(self):
        self.file_path = '/home/project/GraphCLHealth/data_pre/eICU_node_seqs.txt'
        self.cooccurrence_matrix = None
        self._read_data(self)

    def _read_data(self):
        inff = open(self.file_path, 'r')
        patient_dict = {}
        # vocab
        token_text = []
        ...
        self.cooccurrence_matrix = co_occ_mat
        ...
        for line in self._read_data():
            if isinstance(line, list):
                ...
                for idx, w in enumerate(line):
                    ...
                    right = [self.vocab[w][0] for w in line[idx + 1: min(idx + windows_size + 1, sentence_len)] if
                             w in self.vocab]
