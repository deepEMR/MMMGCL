...
def create_MIMIC_dataset(input_path):
    ...
    #diagnosis label
    ccs_dx = pd.read_csv('/home/project/DescEmb/datasets/input/ccs_multi_dx_tool_2015.csv')
...
def create_eICU_dataset(input_path):
    ...
    cohort12h = cohort[cohort['unitdischargeoffset'] > 60*12] # 只统计住院时长大于12小时的诊断信息
    ...
    cohort_ei = tempdf.copy().reset_index(drop=True) # reset_index 重置索引
...
def eicu_diagnosis_label(eicu_cohort):
    ...
    eicu_dx = pd.read_csv('/home/project/DescEmb/datasets/input/eicu/diagnosis.csv')
    ...
    icd10_icd9 = pd.read_csv('/home/project/DescEmb/datasets/input/icd10cmtoicd9gem.csv')
