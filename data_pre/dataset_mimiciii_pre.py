...
def generate_graph_files(output_path, encounter_dict, dx_level, pr_level, dx_level1_name, pr_level1_name, dx_map, proc_map):
    enc_dict = encounter_dict
...
def save_processed_files_by_folds(key_list, enc_dict, output_path, node_str2int):
    ...
    file = open(output_path + '/mimiciii_A.txt', 'w')
    ...
    file = open(output_path + '/mimiciii_graph_indicator.txt', 'w')
    ...
    file_lable1 = open(output_path + '/mimiciii_graph_labels.txt', 'w')
    ...
    file = open(output_path + '/mimiciii_node_types.txt', 'w')
    file3 = open(output_path + '/mimiciii_node_labels.txt', 'w')
    file2 = open(output_path + '/mimiciii_node_seqs.txt', 'w')
...
def main(argv):
    ...
    output_path = '/home/project/GraphCLHealth/processed_data/mimiciii'
    minimum_cnt = 5
    ...
    generate_graph_files(output_path, encounter_dict, dx_level, pr_level, dx_level1_name, pr_level1_name, dx_map, proc_map)
